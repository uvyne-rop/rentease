...
def config_check():
    return jsonify({
        ...
        'admin_email_set': bool(get_env('ADMIN_EMAIL')),
        'admin_username_set': bool(get_env('ADMIN_USERNAME')),
        'admin_password_set': bool(get_env('ADMIN_PASSWORD')),
        'admin_bootstrap_token_set': bool(get_env('ADMIN_BOOTSTRAP_TOKEN')),
        'database': DB_DRIVER,
