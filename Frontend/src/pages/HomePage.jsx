  ...
  const whyUs = [
    {
      ...
      desc: 'Every property is personally visited and verified by our team before it goes live.',
      color: 'text-emerald-600 bg-emerald-100',
    },
    {
      icon: Star,
      title: 'Premium Quality',
      desc: 'From budget bedsitters to luxury showrooms — curated for every lifestyle and budget.',
      color: 'text-amber-600 bg-amber-100',
    },
    {
      icon: Zap,
      title: 'Fast & Easy',
      desc: 'Search by county, price, and type. Contact landlords directly with one click.',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          <div className="max-w-2xl">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-primary-300 hover:text-primary-200 font-semibold text-lg transition-colors mb-8">
              <Phone size={18} />
              +254798641087
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-xl mx-auto">
              We connect you with the best properties across Kenya — no hidden fees, full transparency.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-primary-200 text-lg mb-8">
            Browse hundreds of verified listings across Kenya. No hidden fees, no hassle.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/listings"
              className="bg-white text-primary-700 font-bold px-8 py-4 rounded-xl hover:bg-primary-50 transition-colors inline-flex items-center gap-2">
              Browse All Listings <ArrowRight size={18} />
            </Link>
            <Link
              to="/contact"
              className="border-2 border-white/40 text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
